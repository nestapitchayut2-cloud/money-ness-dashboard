> 📎 **ไฟล์นี้เป็นสำเนาสำหรับอ่านทางไกลเท่านั้น (read-only mirror)** — ต้นฉบับตัวจริงที่แก้ไขได้อยู่ที่ `SHARED/weekly-topics.md` บนเครื่อง Ness เท่านั้น
> **ห้ามแก้ไฟล์นี้โดยตรง** — แก้ที่ `SHARED/weekly-topics.md` แล้วให้ Claude sync มาไว้ที่นี่อีกที (sync ทุกครั้งที่ Claude เชื่อมต่อคอมพิวเตอร์ Ness)
